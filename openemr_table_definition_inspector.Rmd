...
Use this tool to View any CREATE TABLE statement in openemr/master/sql/database.sql

Click the Code button on rIght to the see the code producing this application

[Fork This Repo](https://github.com/johnbwilliams/openemr_table_definition_inspector)
...
dfx <- dfy %>%
  mutate(val = ifelse(is_ticked(val), val, tick_it(val)))
# ------------------------------------------------
